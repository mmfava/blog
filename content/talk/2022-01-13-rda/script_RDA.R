...
attach(abio)
names(abio)
spe.rda<-rda(spe.hel~vaz+no3+no2+nh4+nid+pt+st+prec+temp+prof+turb+ph+od+cond) 

## - Índice VID: Fator de inflação da variância
## Ele faz a seleção das var abio - tem que ser menor que 10 pra saber se não tem colinearidade entre as variáveis
vif.cca(spe.rda)
