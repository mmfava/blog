...
excerpt: "Para comemorar o aniversário do IBGE, fiz um pequeno tutorial sobre como produzir um mapa animado em R a partir dos dados deste nosso querido instituto."
...
```{r out.width="90%"}
knitr::include_graphics("https://miro.medium.com/max/1400/1*D7NYCxXEcGi6j7Sw5TeLAw.png")
```
